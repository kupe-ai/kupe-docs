...
Unsolicited Commercial Communication complaints on India voice numbers — 5 business days to submit opt-in proof, then never call the complainant again. See [UCC complaints](/guides/ucc):

- `GET /v1/orgs/{org_id}/plivo/ucc`
- `GET /v1/orgs/{org_id}/plivo/ucc/summary`
- `GET /v1/orgs/{org_id}/plivo/ucc/{reference_id}`
- `POST /v1/orgs/{org_id}/plivo/ucc/{reference_id}/proof`
- `POST /v1/orgs/{org_id}/plivo/ucc/sync`
